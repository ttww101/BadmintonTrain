...
class LCManager {
    ...
    func configure() {
        do {
            try LCApplication.default.set(
                id:  "qED2iy3A2oahlTW2N53Y5gFr-gzGzoHsz",
                key: "7jAD6sWqaSblalrm8WrkKuCM"
            )
        } catch {
            print("")
        }
    ...
    func saveGameRecord(_ team1: teamRecordModel, _ team2: teamRecordModel, _ quarter: Int, completion: @escaping (Bool, Error?) -> Void) {
        do {
            ...
            try todo.set("drop1", value: team1.Drop)
            try todo.set("drop2", value: team2.Drop)
            try todo.set("drive1", value: team1.Drive)
            try todo.set("drive2", value: team2.Drive)
            ...
            case .success(let result):
                ...
                for iii in 0..<todos.count {
                    ...
                    let team1 = teamRecordModel(
                        ...
                        Drop: todos[iii]["drop1"]!.intValue!,
                        Drive: todos[iii]["drive1"]!.intValue!,
                    ...
                    let team2 = teamRecordModel(
                        ...
                        Drop: todos[iii]["drop2"]!.intValue!,
                        Drive: todos[iii]["drive2"]!.intValue!,
